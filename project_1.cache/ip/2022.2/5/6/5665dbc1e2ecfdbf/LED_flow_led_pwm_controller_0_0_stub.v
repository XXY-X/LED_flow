...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, clk_1hz, rst_n, dir_change, pwm_in_100, 
  pwm_in_90, pwm_in_80, pwm_in_70, pwm_in_60, led_out)
/* synthesis syn_black_box black_box_pad_pin="clk,clk_1hz,rst_n,dir_change,pwm_in_100,pwm_in_90,pwm_in_80,pwm_in_70,pwm_in_60,led_out[9:0]" */;
  input clk;
  input clk_1hz;
  input rst_n;
  input dir_change;
