...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_led_pwm_controller is
  ...
  signal \COUNT_MIN_TEMP[0]_i_5_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \COUNT_MAX[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \COUNT_MAX[3]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \COUNT_MAX_TEMP[1]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \COUNT_MAX_TEMP[1]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \COUNT_MAX_TEMP[3]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \COUNT_MIN[0]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \COUNT_MIN[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \COUNT_MIN[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \COUNT_MIN[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \COUNT_MIN_TEMP[1]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \COUNT_MIN_TEMP[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \COUNT_MIN_TEMP[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \COUNT_MIN_TEMP[3]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \COUNT_MIN_TEMP[3]_i_4\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \led_out[13]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \led_out[14]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \led_out[14]_i_4\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \led_out[15]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \led_out[15]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \led_out[15]_i_4\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \led_out[16]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \led_out[16]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \led_out[17]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \led_pos[2]_i_2\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \led_pos[4]_i_3\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \led_pos[4]_i_4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \led_pos[4]_i_7\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \led_pos[4]_i_8\ : label is "soft_lutpair14";
...
\COUNT_MAX_TEMP[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
...
\COUNT_MAX_TEMP[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\COUNT_MAX_TEMP_reg[0]\: unisim.vcomponents.FDPE
    generic map(
      INIT => '1'
    )
        port map (
...
\COUNT_MAX_TEMP_reg[1]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\COUNT_MIN_TEMP[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00F2"
    )
        port map (
...
\COUNT_MIN_TEMP[0]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"0D"
    )
        port map (
...
\COUNT_MIN_TEMP[0]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFF4"
    )
        port map (
...
\COUNT_MIN_TEMP[0]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BABBBABA"
    )
        port map (
...
\COUNT_MIN_TEMP[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00A8AAAA"
    )
        port map (
...
\COUNT_MIN_TEMP[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FE000000"
    )
        port map (
...
\COUNT_MIN_TEMP_reg[0]\: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
