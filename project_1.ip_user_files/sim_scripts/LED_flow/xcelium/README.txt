...
#
# Generated by export_simulation on Tue Dec 17 21:01:49 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './LED_flow.sh' script.

./LED_flow.sh -reset_run
...
./LED_flow.sh -noclean_files

For more information on the script, please type './LED_flow.sh -help'.
